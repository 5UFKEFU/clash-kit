...
require github.com/metacubex/mihomo v1.18.0
...
replace github.com/Dreamacro/clash v1.11.8 => github.com/Dreamacro/clash v1.11.8

replace github.com/shoenig/go-m1cpu => github.com/shoenig/go-m1cpu v0.1.4
